...
$$\Pr(\text{sample $j$ came from population $k$} | X_j, \text{Training data}),$$ 
where $X_j$ denotes the genetic data on test sample $j$. Compare the error rate (step 3) with the error rate you obtained
